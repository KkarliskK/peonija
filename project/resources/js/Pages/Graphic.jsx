                ...
                <div className='absolute top-0 left-0 w-full h-full z-0'>
                    ...
                    <div className='w-28 absolute top-10 left-5 hidden md:block'>
                        ...
                        >
                            ...
                            />
                            <path d="M21 22H9M3 22H5.5" stroke="#1C274C" strokeWidth="1.5" strokeLinecap="round" className='dark:stroke-white' />
                            <path d="M19 22V15" stroke="#1C274C" strokeWidth="1.5" strokeLinecap="round" className='dark:stroke-white' />
                            <path d="M5 22V15" stroke="#1C274C" strokeWidth="1.5" strokeLinecap="round" className='dark:stroke-white'  />
                            <path
