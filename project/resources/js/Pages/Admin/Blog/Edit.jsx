...
export default function BlogEdit({ auth, blog }) {
    ...
    const handleTitleChange = (e) => {
        ...
        setData({
            ...data,
            title,
            slug: data.slug === generateSlug(data.title) ? generateSlug(title) : data.slug
        });
    };
    ...
    return (
        <AuthenticatedLayout auth={auth}>
            <Head title="Rediģēt Bloga Ierakstu" />
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-900">
                        <div className="p-6 bg-white border-b border-gray-200 dark:bg-gray-900 dark:border-0">
                            <h1 className="mb-8 text-3xl font-bold text-center text-accent">Rediģēt Bloga Ierakstu</h1>
