    ...
    return (
        <>
            <main id='about' className='relative h-auto'>
                <div className='absolute top-0 w-full h-1/3 -z-10 dark:hidden'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="dark:opacity-70"> 
                ...
                <div className='container max-w-screen-md mx-auto text-justify'>
                    ...
                    <p className='px-3 mt-8 mb-8 text-xl font-semibold leading-relaxed text-black dark:text-gray-300 fonte'>
                ...
                <div className="flex items-center justify-center w-full">
                    <div className="container flex items-center justify-center">
                        <img 
                            src={peony1} 
                            alt="peony1" 
                            className="w-11/12 h-auto transform rounded-md shadow-lg dark:shadow-gray-900/50 sm:w-1/2"
                        />    
                    </div>
                </div>
                ...
                {/* <div className='flex items-center justify-center w-full p-4 mt-4 sm:mt-0'>
                    <div className='relative grid grid-cols-1 gap-0 sm:grid-cols-2 lg:grid-cols-3'>
                        <img src={peony1} alt="Peony Flower 1" className='w-full h-auto transform rounded-md shadow-lg rotate-3 dark:shadow-gray-900/50'/>
                        <img src={peony2} alt="Peony Flower 2" className='w-full h-auto transform rounded-md shadow-lg -rotate-3 dark:shadow-gray-900/50'/>
                        <img src={peony3} alt="Peony Flower 3" className='w-full h-auto mt-4 transform rounded-md shadow-lg rotate-3 sm:mt-0 dark:shadow-gray-900/50'/>
                    </div>
                </div> */}
                {/* Commented out Bottom SVG */}
